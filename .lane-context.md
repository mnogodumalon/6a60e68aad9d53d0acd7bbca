...
### `betriebsdaten` — Betriebsdaten (type `Betriebsdaten`, one record: `BetriebsdatenEntry`)
Display fields: `messgroesse`
- `zeitstempel` · datetime · Zeitstempel (TT.MM.JJJJ, HH:MM:SS) · required!
- `messgroesse` · text · Messgröße · required! · maxLength 4000
- `wert` · number · Messwert · required!
- `einheit` · text · Einheit · maxLength 4000
