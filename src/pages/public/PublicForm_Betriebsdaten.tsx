...
const PROXY_BASE = '';
const APP_ID = '6a60e68007044c0b94964877';
...
export default function PublicFormBetriebsdaten() {
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-card rounded-xl border border-border p-6 shadow-md">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder=""
              value={fields.wert ?? ''}
              onChange={e => { const n = e.target.value ? Math.max(0, Number(e.target.value)) : undefined; setFields(f => ({ ...f, wert: n })); }}
            />
          </div>
          <div className="space-y-2">
