// Auto-generated. Per-entity form-enhancements config for "Betriebsdaten".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['zeitstempel', 'bereich', 'messgroesse', 'wert', 'einheit', 'bemerkung'],
  defaults: {
    // Erfassungszeitpunkt = jetzt (mit Uhrzeit)
